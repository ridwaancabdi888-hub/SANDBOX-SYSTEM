...
import { type AppRole, type Notification } from "@/lib/types/domain";
    ...
    <>
      <div className="flex h-14 items-center gap-2 border-b border-border px-4">
        ...
        <div className="min-w-0 leading-tight">
          ...
          <div className="text-[10px] text-muted-foreground">{t("nav.cafeteriaSystem")}</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 border-t border-border p-3">
        ...
        <div className="min-w-0 leading-tight">
          ...
          <div className="text-[10px] text-muted-foreground">{t(roleKey(role))}</div>
        </div>
      </div>
    </>
  );
